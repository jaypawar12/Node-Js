...
route.post('/signIn', passport.authenticate("local-auth", { failureRedirect: "/signInPage" }), adminChecked);
...
// Edit Current Admin
route.get('/editCurrentAdmin/:id', editCurrentAdmin);
...
// Change Password 
route.get('/changePasswordPage/:id', changePasswordPage);
